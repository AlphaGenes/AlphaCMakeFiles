...
set(BLAS_LIBRARIES_INCLUDE ${MKL_ROOT}/include/intel64/ilp64)
    ...
    if(WIN32)
        ...
        set(BLAS_LIBRARIES  mkl_blas95_ilp64${CMAKE_FIND_LIBRARY_SUFFIXES} mkl_lapack95_ilp64${CMAKE_FIND_LIBRARY_SUFFIXES} mkl_intel_ilp64${CMAKE_FIND_LIBRARY_SUFFIXES} mkl_intel_thread${CMAKE_FIND_LIBRARY_SUFFIXES} mkl_core${CMAKE_FIND_LIBRARY_SUFFIXES})
    else()
        set(BLAS_PATH "${MKL_ROOT}/lib/intel64")
        set(BLAS_LIBRARIES  libmkl_blas95_ilp64.a libmkl_lapack95_ilp64.a libmkl_intel_ilp64.a libmkl_intel_thread.a libmkl_core.a)
